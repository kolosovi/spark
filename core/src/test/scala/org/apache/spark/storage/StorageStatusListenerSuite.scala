...
class StorageStatusListenerSuite extends SparkFunSuite {
  ...
  private val taskInfo1 = new TaskInfo(0, 0, 0, 0, 0, "big", "dog", TaskLocality.ANY, false)
  private val taskInfo2 = new TaskInfo(0, 0, 0, 0, 0, "fat", "duck", TaskLocality.ANY, false)
